...
const SeekerHome = () => {
  ...
  return (
    <div className="container mx-auto p-4 mt-10" onClick={scrollToTop}>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between bg-gray-200 border border-gray-400 py-2 px-4 md:px-6 rounded-full">
              ...
              <div className="relative mt-2 md:mt-0 bg-gray-200">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="bg-gray-200 font-bold text-gray-400 outline-none text-center text-sm md:text-xl cursor-pointer p-2 pl-8 rounded-r-lg appearance-none"
                >
