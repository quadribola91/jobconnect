...
const Contact2 = () => {
  ...
  return (
    <>
      <h1 className="text-black font-bold text-3xl mb-5 mt-16 md:mt-20">
        Contact us
      </h1>
      <div className="container mx-auto w-full h-auto flex flex-col md:flex-row gap-5 mb-4">
        <section className="w-full md:w-1/2 h-auto bg-black text-white lg:text-xl lg:text-bold rounded-3xl p-8 flex flex-col justify-center items-center flex-grow-1">
          ...
          <div className="bg-gray-100 rounded-3xl font-bold text-center flex-grow-1">
            ...
            <form onSubmit={handleSubmit} className="p-4">
              <input
                ...
                className="w-full mb-3 rounded-3xl justify-center border border-gray-300  py-3 px-3 focus:outline-none focus:border-blue-500"
                placeholder="NAME"
                required
              />
              <input
              ...
              <button
                type="submit"
                className="w-1/2 bg-blue-700 text-white rounded-2xl py-2 px-4 font-semibold hover:bg-blue-400 focus:outline-none focus:bg-blue-600"
              >
                SEND MESSAGE
              </button>
            </form>
